...
;v4.8	- Code efficiency improvements
...
;;;-------------- P11 P12 P13 P14 P39 P51 Code Options --------------------------
...
DebuggerPSW:	MOVB	PSWL, #SCBValue
...
PopRomAddress:  POPS	A						;This retrieves the ROM address for this instruction
